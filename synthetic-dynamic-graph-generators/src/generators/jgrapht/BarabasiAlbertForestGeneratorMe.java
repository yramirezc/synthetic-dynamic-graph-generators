 ...
 */
public class BarabasiAlbertForestGeneratorMe<V, E> implements GraphGenerator<V, E, V>
{
     ...
     */
    public BarabasiAlbertForestGeneratorMe(int t, int n)
    {
        this(t, n, new Random());
    }
     ...
     * @throws IllegalArgumentException in case of invalid parameters
     */
    public BarabasiAlbertForestGeneratorMe(int t, int n, long seed)
    {
     ...
     * @throws IllegalArgumentException in case of invalid parameters
     */
    public BarabasiAlbertForestGeneratorMe(int t, int n, Random rng)
    {
        if (t < 1) {
