 ...
 */
public class BarabasiAlbertGraphGeneratorMe<V, E> implements GraphGenerator<V, E, V>
{
     ...
     */
    public BarabasiAlbertGraphGeneratorMe(int m0, int m, int n)
    {
     ...
     * @throws IllegalArgumentException in case of invalid parameters
     */
    public BarabasiAlbertGraphGeneratorMe(int m0, int m, int n, long seed)
    {
     ...
     * @throws IllegalArgumentException in case of invalid parameters
     */
    public BarabasiAlbertGraphGeneratorMe(int m0, int m, int n, Random rng)
    {
        if (m0 < 1) {
